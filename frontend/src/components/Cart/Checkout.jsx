        ...
        products :[
            {
                ...
                color:"Black",
                price:120,
                image:"https://picsum.photos/536/354?random=66"
            },
            {
                ...
                color:"White",
                price:75,
                image:"https://picsum.photos/536/354?random=65"
            }
        ],
        totalPrice:195,
    };
  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto py-10 px-6 tracking-tighter '>
        ...
        <div className='bg-gray-50 p-6 rounded-lg'>
            ...
            <div className='flex justify-between items-centertext-lg mt-4 border-t pt-4'>
                <p>Total</p>
                <p>${cart.totalPrice?.toLocaleString()}</p>
            </div>
        </div>
